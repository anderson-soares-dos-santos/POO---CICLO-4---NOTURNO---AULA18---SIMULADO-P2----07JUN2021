...
<html>
    <head>
        ...
        <title>Disciplinas - SIMULADO P2 - JdbcDisciplinasWebApp</title>
    </head>
     <body>
	...
	<div class="form-group">
        ...
        <hr/>
         ...
         <%-- 
            ********TESTE CADASTRO*********************
            ESSE TESTADO E FUNCIONANDO!!!!!
        <form method="post">
            DIA DA SEMANA: <input type="text" name="diaSemana"/>
            DISCIPLINA: <input type="text" name="name"/>
            CODIGO DA DISCIPLINA: <input type="text" name="codDisciplina"/>
            HORÁRIO: <input type="text" name="horario"/>
            AULAS: <input type="text" name="aulas"/>
            PROFESSOR: <input type="text" name="professor"/>
            NOTA - P1: <input type="text" name="notaP1"/>
            NOTA - P2: <input type="text" name="notaP2"/>
